...
#' @return an updated flash object
#' @export
flash_update_single_factor = function(f,k){
...
#' @return an updated flash object
#' @export
flash_update_precision = function(f){
  sigma2 = colMeans(get_R2(f),na.rm=TRUE)
